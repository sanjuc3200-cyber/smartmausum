...
import { Search, X, MapPin, Check, AlertTriangle, Sparkles, Wind, Droplets } from "lucide-react";
import { CITIES, CONDITION_LABEL, alertsForCity, type City } from "@/lib/weather-data";
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-border/60 px-5 py-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[11px] text-muted-foreground">Choose from 16+ official IMD weather stations</p>
            </div>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-4 pb-2">
          <div className="relative flex items-center">
            ...
            <input
              ...
              placeholder="Search by city name or state (e.g. Mumbai, Delhi, Kerala)..."
        ...
        <div className="max-h-[360px] overflow-y-auto px-4 pb-4 divide-y divide-border/40">
          {filteredCities.length === 0 ? (
            <div className="py-12 text-center text-muted-foreground">
              <p className="text-sm font-semibold">No cities found matching "{search}"</p>
              <p className="mt-1 text-xs">Try searching for Delhi, Mumbai, Bengaluru, or Hyderabad</p>
            </div>
          ) : (
        ...
        <div className="border-t border-border/60 bg-muted/40 px-5 py-2.5 text-center text-[11px] text-muted-foreground flex items-center justify-between">
          <span>Official IMD Observation Network</span>
